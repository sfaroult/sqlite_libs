...
extern void my_adddate(sqlite3_context * context, 
                       int               argc, 
                       sqlite3_value  ** argv) {
   ...
   // adddate(<date>, <expr>)   -- unit defaults to days
   // adddate(<date>, <expr>, <unit>)
   // adddate(<date>, 'interval <something> <unit>')
   //
   ...
   //
   _ksu_check_arg_cnt(argc, 2, 3, "adddate");
   if (argc == 2) {
